...
allCaps = runners.map(function(a){
...
largeShirts = runners.filter(function(a){
//True or false
...
ticketPriceTotal = runners.reduce(function(accumulator, a){

  return accumulator + a.donation;
}, 0)
